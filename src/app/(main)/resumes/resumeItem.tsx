...
import { deleteResumes } from "./actions";
    ...
    return <div className="group relative border rounded-lg border-transparent hover:border-border transition-colors bg-secondary p-3">
        <div className="space-y-3">
            ...
            className="relative inline-block w-full">
                ...
                <div
                className="absolute insert-x-0 bottom-0 h-16 bg-gradient-to-t from-white to to-transparent">
                </div>
            </Link>
        </div>
        <MoreMenu 
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent>
                ...
                onClick={onPrintClick}>
                    <Printer className="size-4"></Printer>
                    Print
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
    ...
    return <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    These will permanently delete this resume. This action cannot be undone.
                </DialogDescription>
            </DialogHeader>
            <DialogFooter>
                <LoadingButton
